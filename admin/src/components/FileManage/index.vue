  ...
  <div class="app-container">
    ...
    <el-row>
      <el-col class="mb-2">
        ...
        <el-input v-model="query.search_value" class="ya-search-value mr-2" placeholder="查询内容" clearable />
        <el-select v-model="query.date_field" class="ya-date-field mr-2" placeholder="时间类型">
    ...
    <el-row>
      <el-col class="mb-4">
        ...
        <el-select
          ...
          class="ya-search-field ya-margin-left mr-2"
          filterable
          clearable
          placeholder="排序字段"
          @change="sort"
        ...
        <el-select
          ...
          class="ya-select-field ya-margin-left mr-4"
          filterable
          clearable
          placeholder="分组"
          @change="groupSelect"
        ...
        <el-tooltip :content="'添加' + groupName" effect="light">
          <svg-icon class="mr-2" icon-class="plus" @click="groupAdd()" />
        </el-tooltip>
        <el-tooltip :content="'修改' + groupName" effect="light">
          <svg-icon class="mr-2" icon-class="edit" @click="groupEdit()" />
        </el-tooltip>
        <el-tooltip :content="'删除' + groupName" effect="light">
          <svg-icon class="mr-2" icon-class="delete" @click="groupDele()" />
        </el-tooltip>
        <!-- 标签筛选 -->
        <el-select
          v-model="query.tag_ids"
          class="ya-select-field ya-margin-left mr-2"
          filterable
          clearable
          multiple
          collapse-tags
        ...
        <el-tooltip :content="'添加' + tagName" effect="light">
          <svg-icon class="mr-2" icon-class="plus" @click="tagAdd()" />
        </el-tooltip>
        <el-tooltip :content="'修改' + tagName" effect="light">
          <svg-icon class="mr-2" icon-class="edit" @click="tagEdit()" />
        </el-tooltip>
        <el-tooltip :content="'删除' + tagName" effect="light">
          <svg-icon class="mr-2" icon-class="delete" @click="tagDele()" />
        </el-tooltip>
