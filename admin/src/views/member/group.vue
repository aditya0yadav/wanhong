<template>
  <div class="app-container">
    ...
    <el-row>
      <el-col class="mb-4">
        <el-button plain type="primary" @click="add()">添加</el-button>
        <el-button plain type="danger" title="删除" @click="selectOpen('dele')">删除</el-button>
        <el-button plain type="warning" title="是否禁用" @click="selectOpen('disable')">禁用</el-button>
        <el-button title="是否默认" @click="selectOpen('defaults')">默认</el-button>
        <el-button title="修改接口" @click="selectOpen('editapi')">接口</el-button>
        <el-button class="mr-3" title="解除会员" @click="selectOpen('removem')">解除会员</el-button>
        <el-select v-model="query.search_field" class="ya-search-field mr-2" placeholder="查询字段">
