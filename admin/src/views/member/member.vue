  ...
  <div class="app-container">
    ...
    <el-row>
      <el-col class="mb-4">
        ...
        <el-select v-model="query.date_field" class="ya-date-field mr-2" placeholder="时间字段">
          ...
          <el-tab-pane label="基础信息">
            <el-scrollbar native :height="height - 80">
              ...
              <el-form-item label="所属团队" prop="team_id">
                <el-select v-model="model.team_id" class="w-full" clearable filterable>
                  <el-option
                    v-for="item in teams"
                    :key="item.team_id"
          ...
          <el-tab-pane label="权限信息">
            <el-scrollbar native :height="height - 80"><!--
              <el-form-item label="超会" prop="is_super">
                <el-switch v-model="model.is_super" :active-value="1" :inactive-value="0"  />
              </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        team_id: [{ required: true, message: '请选择所属团队', trigger: 'blur' }],
      },
      genders: [],
      platforms: [],
      applications: [],
