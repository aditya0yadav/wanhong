            ...
            <div class="app-container">
                ...
                <el-row>
                    <el-col class="mb-4">
                        ...
                        <el-button type="default" title="查询/刷新" @click="rewardSearch()">查询</el-button>
                ...
                <el-table ref="table" v-loading="rewardLoading" :data="rewardData" :height="height - 130"
                    ...
                    <el-table-column prop="platform.platform_name" min-width="120" label="归属平台" />
                    ...
                    <el-table-column prop="backend_rs" min-width="240" label="人设信息" show-overflow-tooltip>
                        <template #default="scope">
                            <span style="white-space: break-spaces;word-break: nowrap;" v-html="getRs(scope.row, 'backend_rs')"></span>
                        </template>
                    </el-table-column>
                    <el-table-column prop="backend_rs" min-width="240" label="人设图片" show-overflow-tooltip>
                        <template #default="scope">
                            <span style="white-space: break-spaces;word-break: nowrap;" v-html="getRsImg(scope.row, 'backend_rs')"></span>
                        </template>
                    </el-table-column>
                    ...
                    <el-scrollbar native>
                        <el-form label-width="120px">
                            ...
                            <el-form-item label="审核" v-if="selectType === 'auth'">
                                <el-text size="default" type="danger">确定要审核选中的业绩吗？</el-text>
                            </el-form-item>
                            ...
                            <el-form-item label="审核状态" v-if="selectType === 'auth'">
                                <el-radio-group v-model="authType">
                                    <el-radio class="model-mr" :value="1">成功</el-radio>
                                    <el-radio :value="2">失败</el-radio>
                                </el-radio-group>
                            </el-form-item>
