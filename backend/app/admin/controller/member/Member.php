...
class Member extends BaseController
{
    ...
    public function listAll(MemberModel $memberModel){
        return success($memberModel->where('is_disable',0)->where('is_delete',0)->field(['member_id','nickname','username'])->select());
    }
