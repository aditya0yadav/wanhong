...
class Utils
{
    ...
    public static function decodeParam($platformParams){
        $str_arr = [];
        foreach ($platformParams as $param){
            if($param['name'] == 'app_id'){
                $str_arr['app_id'] = $param['value']; 
            }
            if($param['name'] == 'pub_id'){
                $str_arr['pub_id'] = $param['value']; 
            }
            if($param['name'] == 'app_key'){
                $str_arr['app_key'] = $param['value']; 
            }
            if($param['name'] == 'app_secret'){
                $str_arr['app_secret'] = $param['value']; 
            }
            if($param['name'] == 'app_token'){
                $str_arr['app_token'] = $param['value']; 
            }
            if($param['name'] == 'app_service_key'){
                $str_arr['app_service_key'] = $param['value']; 
            }
            if($param['name'] == 'app_service_secret'){
                $str_arr['app_service_secret'] = $param['value']; 
            }
        }
        return $str_arr;
    }
